...
public class GraphicSystem extends JFrame {
	...
	private void saveCurrentState () {
		ImageIcon currentIcon = (ImageIcon) imgPanel.getIcon();
		operations.push(new GSOperation(currentIcon, imageFilenames)); 
	}
	...
	private void undo () {
		if (operations.isEmpty()) System.out.println("No operation to undo.");
			...
			GSOperation lastOperation = operations.pop(); 
			ImageIcon lastIcon = lastOperation.getImage(); 
			imageFilenames = lastOperation.getImageQueue(); 
